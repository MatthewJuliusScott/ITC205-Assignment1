...
public class Carpark implements ICarpark {
	...
	/**
	 * Package method for testing purposes only. Gets the number of cars parked
	 * in Carpark.
	 *
	...
	public boolean isSeasonTicketInUse(String ticketId) {
		...
		if (ticket == null) {
			throw new RuntimeException(
			        "recordSeasonTicketExit: invalid ticketId - " + ticketId);
		}
	...
	public void recordSeasonTicketEntry(String ticketId) {
		...
		if (ticket == null) {
			throw new RuntimeException(
			        "recordSeasonTicketEntry: invalid ticketId - " + ticketId);
		}
